      ...
      vulnerabilities: [
        {
          ...
          evidence: 'User ID 1234 accessible without authentication',
        ...
        },
        {
          ...
          severity: 'critical',
          description: 'Weak JWT token validation allows token forgery',
          endpoint: '/api/auth/login',
          evidence: 'JWT signature verification disabled',
          recommendation: 'Enable strict JWT signature validation'
        },
        {
          id: 'API3:2023',
          ...
          endpoint: '/api/users/{id}',
          evidence: 'isAdmin field modifiable',
        ...
        },
        {
          ...
          endpoint: '/api/search',
          evidence: '1000+ requests/second without throttling',
          recommendation: 'Implement rate limiting'
        }
      ],
      endpointsTested: 23,
      requestsSent: 1847,
      payloadsGenerated: 342
    };

    setScanResults(mockResults);
    setScanHistory((prev) => [mockResults, ...prev]);
    setScanning(false);
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-lg p-6 text-white">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-3xl font-bold">
                    {scanHistory.reduce((sum, s) => sum + s.endpointsTested, 0)}
                  </span>
                </div>
